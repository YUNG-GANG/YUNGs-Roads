...
public interface RoadSegmentType<C extends DefaultRoadSegment> {
     ...
     */
    static <C extends DefaultRoadSegment> RoadSegmentType<C> register(ResourceLocation resourceLocation, MapCodec<C> codec) {
     ...
     */
    private static <C extends DefaultRoadSegment> RoadSegmentType<C> register(String id, MapCodec<C> codec) {
        return register(YungsRoadsCommon.id(id), codec);
    }
